...
#define USBD_CDC_0_EP_NOTIF 0x81
#define USBD_CDC_0_EP_OUT 0x02
#define USBD_CDC_0_EP_IN 0x82
#define USBD_CDC_EP_NOTIF_SIZE 8
...
static const uint8_t usbd_desc_cfg[USBD_DESC_LEN] = {
        ...
        TUD_CDC_DESCRIPTOR(USBD_ITF_CDC_0, USBD_STR_CDC, USBD_CDC_0_EP_NOTIF,
                           USBD_CDC_EP_NOTIF_SIZE, USBD_CDC_0_EP_OUT, USBD_CDC_0_EP_IN,
